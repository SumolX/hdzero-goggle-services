...
if(DEFINED CMAKE_TOOLCHAIN_FILE)
	...
	file(APPEND ${PROJECT_BINARY_DIR}/toolchain.sh "export CXX=${COMPILER_PATH}/${TARGET_PLATFORM}-g++\n")
	file(APPEND ${PROJECT_BINARY_DIR}/toolchain.sh "export AR=${COMPILER_PATH}/${TARGET_PLATFORM}-ar\n")
	file(APPEND ${PROJECT_BINARY_DIR}/toolchain.sh "export LD=${COMPILER_PATH}/${TARGET_PLATFORM}-gcc\n")
	...
	file(APPEND ${PROJECT_BINARY_DIR}/toolchain.sh "export AS=${COMPILER_PATH}/${TARGET_PLATFORM}-gcc\n")
