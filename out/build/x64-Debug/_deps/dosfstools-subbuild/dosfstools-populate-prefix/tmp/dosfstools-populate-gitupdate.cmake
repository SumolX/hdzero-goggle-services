...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v4.2"
  WORKING_DIRECTORY "D:/Project Source/sandboxGitHub/hdzero-goggle-services/out/build/x64-Debug/dosfstools/src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v4.2" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Project Source/sandboxGitHub/hdzero-goggle-services/out/build/x64-Debug/dosfstools/src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Project Source/sandboxGitHub/hdzero-goggle-services/out/build/x64-Debug/dosfstools/src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
