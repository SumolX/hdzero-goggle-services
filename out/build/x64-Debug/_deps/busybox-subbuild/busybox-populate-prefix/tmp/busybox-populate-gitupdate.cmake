...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "1_27_2"
  WORKING_DIRECTORY "D:/Project Source/sandboxGitHub/hdzero-goggle-services/out/build/x64-Debug/busybox/src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1_27_2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/1_27_2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Project Source/sandboxGitHub/hdzero-goggle-services/out/build/x64-Debug/busybox/src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Project Source/sandboxGitHub/hdzero-goggle-services/out/build/x64-Debug/busybox/src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
